...
![Pipeline Architecture](images/Screenshot%20from%202025-11-05%2007-15-36.png)
...
The pipeline is designed to handle multi-city delivery data processing with parallel task execution, ensuring efficient data processing and transformation.
...
4. **Access Airflow**:
   ...
   ![Airflow UI](images/Screenshot%20from%202025-11-05%2007-16-09.png)
...
│   ├── nexus_drive_etl_pipeline_DAG.py
...
3. Monitor the DAG execution and verify the output in PostgreSQL.
   ...
   ![DAG Execution View](images/Screenshot%20from%202025-11-05%2007-41-24.png)

### Pipeline Execution Flow

The pipeline processes data for multiple cities (jl, yt, hz, cq, sh) in parallel:
- **Extract**: Downloads delivery and weather data from MinIO for each city
- **Transform**: Enriches delivery data with weather conditions, traffic patterns, and vehicle information
- **Load**: Combines all enriched datasets and stores them in PostgreSQL

Each city is processed independently in parallel, ensuring optimal performance and scalability.
